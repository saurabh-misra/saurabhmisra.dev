...
<a href="//jsfiddle.net/saurabhmisra87/nL7j4p08/2" className="sm-btn-primary" target="_blank">Check out the code in jsFiddle</a>
<p></p>
...
<a href="//jsfiddle.net/saurabhmisra87/pgL1yv95/16" className="sm-btn-primary" target="_blank">Check out the code in jsFiddle</a>
<p></p>
