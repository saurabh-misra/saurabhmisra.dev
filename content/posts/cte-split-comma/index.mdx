...
### 1. Using a CTE
This is my most preferred way since it is simple and understandeable.
...
You can find more information about it [here](https://docs.microsoft.com/en-us/sql/t-sql/functions/string-split-transact-sql?view=sql-server-ver15).
