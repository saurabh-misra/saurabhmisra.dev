...
```js title=vite.config.js highlight=2,8-34
// existing imports 
...
The <a href="https://vite-pwa-org.netlify.app/assets-generator/#source-images" target="_blank">PWA plugin documentation strongly suggests using a single SVG file as the source for PWA assets</a>.
