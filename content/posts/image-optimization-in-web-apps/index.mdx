...
There are also third-party services like <a href="https://tinyjpg.com/" target="_blank">TinyJPG</a> that allow you to invoke an API to compress JPG and PNG images.
