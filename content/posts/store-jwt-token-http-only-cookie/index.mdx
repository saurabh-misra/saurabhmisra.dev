...
<img src={consoleOutputFetchAxiosAjaxCalls} className="output-screenshots" />
...
<img src={devToolsHttponlyCookieSet} className="output-screenshots" />
...
<img src={devToolsCookieRequestHeader} className="output-screenshots" />
...
<img src={serverConsoleReqCookies} className="output-screenshots" />
